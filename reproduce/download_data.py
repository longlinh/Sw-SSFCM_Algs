...
Four of the six scenes (Indian Pines, Pavia University, Kennedy Space Center,
Botswana) are redistributed openly by the Computational
...
-----
    ...
    python reproduce/download_data.py --data-root ~/data/HSI --dataset botswana
